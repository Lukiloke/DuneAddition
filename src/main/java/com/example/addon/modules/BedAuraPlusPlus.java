...
public class BedAuraPlusPlus extends Module {
    ...
    public BedAuraPlusPlus() {
        super(Dune.Main, "bed-aura-plus-plus", "Automatically places and explodes beds in the Nether and End.");
    }
