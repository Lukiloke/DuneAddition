...
import static com.example.addon.utils.TPUtils.findTPPath;
...
public class InfiniteInteract extends Module {
    ...
    public InfiniteInteract() {
        super(Dune.Main, "infinite-interact", "Allows you to interact with blocks and entities at a distance. (require reach module)");
    }
